<ul class="nav">
  <li class="redir"><a class="nav-buttons <?php if($_SESSION['active-nav'] == "changelog"){echo 'active-nav-item';}?>" href="https://gdhplatformers.hpsk.me/index.php">Platformers</a></li>
    ...
    <li class="redir"><a class="nav-buttons <?php if($_SESSION['active-nav'] == "homepage"){echo 'active-nav-item';}?>" href="homepage.php">Main List</a></li>
    ...
    <button onclick="dropMenu()" class="dropbtn">Go To...</button>
        <div id="myDropdown" class="dropdown-content">
            <a class="nav-buttons <?php if($_SESSION['active-nav'] == "homepage"){echo 'active-nav-item';}?>" href="homepage.php">Main List</a>
            ...
            <a class="nav-buttons <?php if($_SESSION['active-nav'] == "Insane Demon List"){echo 'active-nav-item';}?>" href="InsaneDemonList.php">Insane Demon List</a>
